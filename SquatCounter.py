...
def detect_exercise(angles, prev_exercise, angle_changes):
    ...
    # Basic example rules (can be adjusted or replaced with more robust logic/ML models):
        ...
        while cap.isOpened():
            ...
            try:
                ...
                if current_exercise:
                    ...
                    b = [landmarks[ex.angle_points[1]].x,
                         landmarks[ex.angle_points[1]].y]
                    c = [landmarks[ex.angle_points[2]].x,
                         landmarks[ex.angle_points[2]].y]
                    ...
                    if current_exercise == "Squat":
                        ...
                        if angle < min_angle:
                            cv2.putText(
                                image,
                                "Going too deep or leaning forward!",
                                (50, image_height - 50),
                                cv2.FONT_HERSHEY_SIMPLEX,
                                0.9,
                                (0, 0, 255),
